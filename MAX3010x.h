...
class MAX3010x {
 public: 
  ...
  boolean begin(TwoWire &wirePort = Wire, uint32_t i2cSpeed = I2C_SPEED_STANDARD, uint8_t i2caddr = MAX3010x_ADDRESS);
  ...
  void setup(uint8_t powerLevel = 0x1F, uint8_t sampleAverage = 4, uint8_t ledMode = 3, uint16_t sampleRate = 400, uint16_t pulseWidth = 411, uint16_t adcRange = 4096);
