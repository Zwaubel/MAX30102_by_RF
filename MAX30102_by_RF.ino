...
const byte batteryPin = 35;
const byte ledPin = 33; // Red LED on ADALOGGER
...
void setup() {
  ...
  float measuredvbat = analogRead(batteryPin) / 4096 / 2 / 4.2; // This returns the voltage (max range / voltage divider / max battery voltage )
